...
/**
 * A class that helps connect the code to the Database
 *
 */
public class DatabaseUtil {

	// Information to access our database
	...
	public final static String dbName = "innodb"; // default created from MySQL
													// WorkBench
